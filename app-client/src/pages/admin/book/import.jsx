...
import { createBulkBookAPI } from '../../../services/book.service.js'
...
const ImportModal = (props) => {
    ...
    const handleImport = async () => {
        setLoading(true)
        const res = await createBulkBookAPI(data)
        setLoading(false)
        if (res && !res.error) {
    ...
    const columns = [
        ...
        {
            title: common('module.book.weight'),
            dataIndex: 'weight',
        },
        {
            title: common('module.book.page_number'),
