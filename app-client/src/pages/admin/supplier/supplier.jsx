...
const SupplierPage = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                title: common('module.supplier.name'),
                dataIndex: 'name',
                sorter: true,
            },
            {
                title: common('module.supplier.address'),
                dataIndex: 'address',
                sorter: true,
            },
            {
                title: common('module.supplier.tax_code'),
                dataIndex: 'taxCode',
                sorter: true,
            },
            {
            ...
            },
            {
                ...
                render: (_, record) => (
                    <Space>
                        ...
                        <Popconfirm
                            title={common('module.supplier.delete')}
                            description={common(
                                'module.supplier.delete_confirm',
                                {
                                    name: record?.name,
                                }
                            )}
    ...
    return (
        <div style={{ background: '#fff', borderRadius: 8, padding: 16 }}>
            <Flex gap={8} style={{ marginBottom: 16 }} justify="space-between">
                <Input
                    placeholder={common('module.supplier.search')}
                    style={{ maxWidth: 320 }}
