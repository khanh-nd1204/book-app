...
import { getExportsAPI } from '../../../services/export.service.js'
import { useNavigate } from 'react-router-dom'
import ExportPDF from '../export/export-pdf.jsx'
...
const BookExportPage = () => {
    ...
    const getData = useCallback(async () => {
        ...
        setLoading(true)
        const res = await getExportsAPI(query)
        setLoading(false)
        if (res && res.data) {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                dataIndex: 'supplier',
                render: (_, { supplier }) => (
                    <div style={{ maxWidth: 240 }}>{supplier.name}</div>
                ),
                sorter: true,
            },
            {
            ...
            {
                title: common('module.export.note'),
                dataIndex: 'note',
                render: (_, { note }) => (
